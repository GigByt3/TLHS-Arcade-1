...
public class GameSceneManager : MonoBehaviour
{
    ...
    private void SetUpGame(int mazeSize, int INTROindex, int LOOPindex)
    {
        ...
        maze.MazeConstructor(mazeSize, mazeSize, Resources.Load<GameObject>("Player"), Resources.Load<GameObject>("ExitDoor"), enemyPrefabs, Resources.Load<Material>("Wall"), cellWidth, 20, 1.0f);
        maze.Ready();
    }
